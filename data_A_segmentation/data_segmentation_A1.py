...
file_name = 'KaresiouWear_2024-06-16T17.41.54.621_F5174DCC3C91_Both.csv'
...
def classify_movement(row):
    if row['y-axis (deg/s)'] < 0.453 and row['y-axis (deg/s)'] > 0.4: 
        if row['energy'] < 0.59 and row['energy'] > 0.38: 
            return 0
        else:
            return 1
    else:
